				...
				{#each services as service, i}
					...
					>
						...
						<div class="relative z-10">
							<!-- Service Icon -->
							<div
								class="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-primary-500/10 text-5xl transition-all duration-500 group-hover:scale-110 group-hover:bg-primary-500/20 group-hover:shadow-lg group-hover:shadow-primary-500/30"
							>
								{service.icon}
							</div>
